...
$API_KEY = "Hello, Telegram  administration I cannot log into my account nor create an account on Telegram. When I log in the message comes to telegram. This number is blocked on telegram, so I think I am banned from restricted use of Telegram by accident and I really don’t know why Telegram did this for me so you can verify  From my account for that.  I am using my phone number" ;#توكن بوتك
